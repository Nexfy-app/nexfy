...
export default function LocationConfigModal({ professional, open, onClose, onSaved }) {
  ...
  // Capture GPS for realtime / current options
  ...
  const handleSave = async () => {
    ...
    // Validate: fixed mode requires coordinates from geocode OR existing coords
    ...
    if (locationType === 'fixed') {
      ...
      // If no new geocode, keep existing lat/lng (already in DB)
