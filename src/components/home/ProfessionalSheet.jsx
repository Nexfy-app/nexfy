        ...
        <div className="px-5 space-y-3 pb-6">
          ...
          <div className="flex items-start gap-2.5 bg-slate-50 border border-slate-200 rounded-2xl p-3">
            ...
            <p className="text-[11px] text-slate-600 leading-relaxed">
              <strong>O NEXFY não processa pagamentos.</strong> Somos apenas uma plataforma de conexão entre clientes e profissionais. Valores, condições e formas de pagamento são acordados e realizados <strong>diretamente entre as partes</strong>.
            </p>
          </div>
