...
const steps = [
  ...
  },
  {
    ...
    tip: 'Avaliações honestas fortalecem a comunidade do SERV.',
  ...
  },
  {
    ...
    description: 'O SERV não processa pagamentos. Clientes e profissionais combinam o valor e a forma de pagamento diretamente (Pix, dinheiro, etc.).',
