...
export default function About() {
  return (
    <div className="min-h-screen bg-background px-4 py-10 max-w-2xl mx-auto">
      ...
      <h1 className="text-3xl font-black text-foreground mb-4">Sobre o Nexfy</h1>

      <p className="text-muted-foreground text-sm leading-relaxed mb-4">
        O <strong>Nexfy</strong> é uma plataforma brasileira que conecta clientes a profissionais de serviços locais em tempo real. Nossa missão é simples: tornar a contratação de um eletricista, encanador, pintor, diarista ou qualquer outro profissional tão fácil quanto pedir uma pizza.
      </p>
